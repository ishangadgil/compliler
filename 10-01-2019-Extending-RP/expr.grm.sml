...
|  ( 8, ( ( _, ( MlyValue.EXP EXP2, _, EXP2right)) :: _ :: ( _, ( MlyValue.EXP EXP1, EXP1left, _)) :: rest671)) => let val  result = MlyValue.EXP ((*#line 53.26 "expr.grm"*) Ast.div   EXP1 EXP2 (*#line 203.1 "expr.grm.sml"*)
)
 in ( LrTable.NT 0, ( result, EXP1left, EXP2right), rest671)
end
|  ( 9, ( ( _, ( _, _, RPRAN1right)) :: ( _, ( MlyValue.EXP EXP, _, _)) :: ( _, ( _, LPRAN1left, _)) :: rest671)) => let val  result = MlyValue.EXP ((*#line 54.26 "expr.grm"*) EXP (*#line 207.1 "expr.grm.sml"*)
)
 in ( LrTable.NT 0, ( result, LPRAN1left, RPRAN1right), rest671)
end
...
fun LPRAN (p1,p2) = Token.TOKEN (ParserData.LrTable.T 5,(ParserData.MlyValue.VOID,p1,p2))
fun RPRAN (p1,p2) = Token.TOKEN (ParserData.LrTable.T 6,(ParserData.MlyValue.VOID,p1,p2))
